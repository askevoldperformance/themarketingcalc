...
<main>
  <section class="page-hero"><div class="container">
    ...
    <div class="page-hero-title"><img src="/images/icon-budget-calculator.png" alt="" class="tool-page-icon"><h1>Marketing <span class="accent">Budget Calculator</span></h1></div>
  ...
  <section class="budget-section"><div class="container">
    <div class="budget-card">
      ...
      <div class="budget-step">
        ...
        <div id="budget-to-results-inputs" style="margin-top:12px;">
        ...
        <div id="goals-to-budget-inputs" class="hidden" style="margin-top:12px;">
        ...
        <div id="audience-to-budget-inputs" class="hidden" style="margin-top:12px;">
          <p class="audience-mode-hint">No targets needed. We will estimate the budget required to reach your selected age groups at the frequency you choose on each selected channel.</p>
          <div class="audience-mode-fields">
            <div class="input-group">
              <label>Campaign length (weeks)</label>
              <input type="number" id="campaign-weeks" value="4" min="1" max="52" placeholder="4">
            </div>
            <div class="input-group">
              <label>Target frequency per person</label>
              <input type="number" id="target-frequency" value="3" min="1" max="20" placeholder="3">
              <span class="step-hint" style="display:block;margin-top:4px;">How many times each person sees your ad. 3-5x is a common awareness target.</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="budget-step">
        <h3>3. Audience filter <span class="step-hint">optional</span></h3>
        ...
        <div class="audience-size-display" id="audience-size-display"></div>
        <p class="filter-disclaimer">Population and reach estimates use national demographic distribution averages. Treat these as a planning ceiling, not a guarantee.</p>
      </div>

      <div class="budget-step">
        <h3>4. Channels <span class="step-hint">budget will be split across selected channels</span></h3>
      ...
      <div class="budget-step">
        ...
        <div id="conversions-extra" class="hidden" style="margin-top:16px;">
          <p class="step-hint" style="margin-bottom:10px;">Optional: enter these to get estimated revenue and ROAS in results.</p>
          <div class="audience-mode-fields">
            <div class="input-group">
              <label>Average Order Value (<span class="currency-label">USD</span>)</label>
              <input type="number" id="aov-input" placeholder="e.g. 85" min="0">
            </div>
            <div class="input-group">
              <label>Website Conversion Rate (%)</label>
              <input type="number" id="cvr-input" placeholder="e.g. 2.5" min="0" max="100" step="0.1">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="budget-step">
        <h3>6. Custom metrics <span class="step-hint">optional - overrides benchmark data per channel</span></h3>
        <div class="custom-toggle-row">
          <label class="switch-label">
            ...
            <span>Use your own CPM / CPC / CTR</span>
          </label>
        </div>
